export const translations = {
    en: {
        ...
        homeLoadNearbyCenters: 'Load nearby blood donation centers',
        ...
        settingsPatientPreferredCenterHelp: 'Enter a center manually or load suggestions for the city above.',
        settingsPatientPreferredCenterLoad: 'Load center suggestions',
        ...
        preferredCenterStatus: {
            'missing-city': 'Enter a city first to load matching centers.',
            'missing-api-key': 'Add EXPO_PUBLIC_GOOGLE_PLACES_API_KEY to load center suggestions.',
            empty: 'No centers found for this city.',
            error: 'Could not load center suggestions.'
        },
        placesStatus: {
            idle: 'Press the button above to load nearby centers. Location permission will be requested then.',
    ...
    pl: {
        ...
        homeLoadNearbyCenters: 'Załaduj centra krwiodawstwa w pobliżu',
        ...
        settingsPatientPreferredCenterHelp: 'Wpisz centrum ręcznie albo załaduj sugestie dla miasta podanego wyżej.',
        settingsPatientPreferredCenterLoad: 'Załaduj sugestie centrów',
        ...
        preferredCenterStatus: {
            'missing-city': 'Najpierw wpisz miasto, aby załadować pasujące centra.',
            'missing-api-key': 'Dodaj EXPO_PUBLIC_GOOGLE_PLACES_API_KEY, aby ładować sugestie centrów.',
            empty: 'Nie znaleziono centrów dla tego miasta.',
            error: 'Nie udało się załadować sugestii centrów.'
        },
        placesStatus: {
            idle: 'Naciśnij przycisk powyżej, aby załadować pobliskie centra. Dopiero wtedy poprosimy o lokalizację.',
